...
<div class="flex justify-normal gap-6"> 
    <button class="py-1 px-2 bg-white border border-blue-400 text-blue-400 text-sm rounded-lg">Add to cart</button>
    <div  class="absolute top-2 ">
        <HomeHeart/>
    </div>
    <button class="py-1 px-2 bg-white border border-gray-200 text-blue-400 rounded-lg" @click="goToProductDetails(product.id)" ><Icon name="uil:eye" color="black"/></button>
</div>
    </li>
</ul>
